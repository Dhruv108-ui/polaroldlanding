...
function Casestudy({title,description, thumbnail, createdAt}) {
    ...
    useEffect(() => {
        setTimeToRead(timeToReadBlog(description))
        document.getElementById('blog_description').innerHTML = description
    }, [])
  ...
  return (
    <>
        ...
        <div className="banner mt-12">
            <img className='w-full' src={thumbnail} alt="no image" />
        </div>
